  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper relative flex h-full min-h-0 w-full overflow-hidden has-data-[variant=inset]:bg-sidebar",
          className
        )}
        {...props}
      >
...
function Sidebar({
  ...
  return (
    <div
      className="group peer relative hidden h-full text-sidebar-foreground md:block shrink-0"
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative h-full w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-linear shrink-0",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "absolute inset-y-0 z-20 hidden h-full w-[var(--sidebar-width)] transition-all duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:-translate-x-full data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:translate-x-full md:flex",
